...
import org.example.app.model.DataObject;
 ...
 */
public class DatasetLoader<O extends DataObject> {
     ...
     * @param function Lambda-Funktion zum Setzen der Objekt-Daten (O.setData())
     * @return Liste von WDI-Objekten
     */
    public List<O> loadDataset(String path, Function<String[], O> function) {
        List<O> dataSet = new ArrayList<>();
        ...
        try (InputStream inStream = getClass().getClassLoader().getResourceAsStream(path);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                O dataObject = function.apply(data);
