 ...
 */
public class CacheSystem<C> {
    private ConcurrentHashMap<C,CacheItem<C>> cache;
     ...
     */
    public void put(C command, String result) {
     ...
     */
    public String get(C command) {
        CacheItem<C> item = cache.get(command);
        if (item != null) {
